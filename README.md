...
Acrobat Pro級の機能をもつPDFエディター。完全ローカル処理。
...
### 商標に関する告知（Trademark Notices）
- **DocForge**: 本ソフトウェアの名称「DocForge」は、独立したオープンソース・プロジェクトとしての呼称です。
- **Adobe, Adobe Acrobat, Acrobat Pro**: Adobe Inc. の米国およびその他の国における登録商標または商標です。本書および本アプリにおける言及は、機能互換性および比較対象の客観的説明を目的としたものであり、Adobe Inc. との提携・推奨・支援関係を示すものではありません。
- **Microsoft, Word, Excel**: Microsoft Corporation の登録商標です。
